...
Scenario:01 Verify whether user with valid credentials is redirected to Profile page
	...
	Then the text <Profile_Name> should be displayed.
...
Examples:
| Email_address        | Password | Skill               | SkillLevel     | UpdatedSkill_Level | 
| "lija2512@gmail.com" | "123456" | "Automated testing" | "Beginner" |     "Intermediate"         |
...
Scenario:04 Verify whether the validations during add skills are working as expected.
	...
	And click on Skill tab
	When the user clicks on AddNew button enters <Skill> and <SkillLevel> and clicks on Add button in the skills section
	And the user clicks on AddNew button enters <Skill1> and <SkillLevel1> and clicks on Add button in the skills section
	Then verify the Add skill validations and also when entering  <Existing_Skill> and <Existing_skilllevel> are working

	Examples: 
	| Email_address        | Password   | Skill               | SkillLevel     | Skill1        | SkillLevel1 | Existing_Skill      | Existing_skilllevel |
	| "lija2512@gmail.com" | "123456"   | "Automated testing" | "Intermediate" | "Programming" | "Beginner"  | "Automated testing" | "Intermediate"      |
    ...
    Examples:
	| Email_address        | Password | Skill         | SkillLevel |
	| "lija2512@gmail.com" | "123456" | "Programming" | "Expert"   |
	...
	Then the user should be redirected to the Profile page
	And click on Skill tab
	When the user clicks on AddNew button enters <Skill1> and <SkillLevel1> and clicks on Add button in the skills section
	And the user clicks on AddNew button enters <Skill> and <SkillLevel> and clicks on Add button in the skills section
	And the user clicks on the cross icon against the <skill> skill record
	Then the <Skill> skill record should be deleted
	 Examples:
	| Email_address        | Password | Skill         | SkillLevel | Skill1              | SkillLevel1 |
	| "lija2512@gmail.com" | "123456" | "Programming" | "Beginner" | "Automated testing" | "Expert"    |
